...
internal sealed class OrgUnitConfiguration : IEntityTypeConfiguration<OrgUnit>
{
    public void Configure(EntityTypeBuilder<OrgUnit> builder)
    {
        ...
        // Stored as text here; production migration converts this column to PostgreSQL `ltree`
        // and adds a GIST index for fast subtree / data-scope queries (docs/design/04 §3.1).
